...
from ..models import Medium, Photographer, Tag
...
class PhotographerUpdaterTest(TestCase):
    ...
    def test_add_photographer_two_names(self):
        """Test the basic case of linking a medium to a photographer where the tag is given and the name
        of the photographer is in the photographer database table"""
    ...
    def test_add_photographer_three_names(self):
        """Test the basic case of tagging a medium with a photographer when the photographer
        has three names (first name, two surnames)."""
