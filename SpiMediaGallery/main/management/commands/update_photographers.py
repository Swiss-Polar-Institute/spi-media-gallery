...
class PhotographerUpdater(object):
    ...
    def update(self):
        ...
        progress_report = ProgressReport(
            photos_without_photographer_count,
        ...
        for photo in photos_without_photographer:
            ...
            ):  # if the photographer cannot be found in the database, then add them to an output
                # list of invalid photographers
    ...
    def _get_photographer(string):
        ...
        photographer = Photographer.objects.filter(first_name=first_name).filter(
            last_name=last_name
        )
